...
export default function LoginPage({ onLoginSuccess, onContinueAsGuest }: LoginPageProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err.code === "auth/popup-closed-by-user") {
        console.warn("Google SSO cancelled by user (popup closed).");
        setErrorMessage("The Google sign-in window was closed. Please try again to authenticate.");
      } else {
    ...
    try {
      ...
      switch (err.code) {
        ...
        case "auth/user-not-found":
          friendlyMessage = "No account found with this email. Consider registering.";
          break;
        ...
        case "auth/operation-not-allowed":
          friendlyMessage = "Email/Password sign-in is disabled in your Firebase Settings. Please use 'Google' or 'Guest Sandbox' below, or enable Email/Password provider in the Firebase Authentication parameters.";
          break;
      }
  ...
  const handleForgotPassword = (e: React.MouseEvent) => {
    e.preventDefault();
    setErrorMessage(null);
    setSuccessMessage("Standard forgot password recovery flow is integrated. Please contact the administrator to trigger credentials reset link.");
  };
